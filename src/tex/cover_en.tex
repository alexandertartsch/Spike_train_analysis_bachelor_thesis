...
%\begin{figure}\raggedleft\includegraphics[height=3.0cm]{}\end{figure}
\vspace*{3em}
...
% vertical lines
\draw[color=se_dark_blue, thick] (-1, 0.9) -- (-1, -25.5);
\draw[color=se_light_blue, thick] (-0.8, 0.7) -- (-0.8, -25.5);
